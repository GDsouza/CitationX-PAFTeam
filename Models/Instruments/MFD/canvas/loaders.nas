...
setlistener("/nasal/canvas/loaded", func() {
  ...
  var load_deps = func(name) {
      ...
      load(aircraft_root~"/Models/Instruments/MFD/canvas/map/"~name~".lcontroller",  name);
      load(aircraft_root~"/Models/Instruments/MFD/canvas/map/"~name~".symbol", name);
  }
  ...
  var map_root = aircraft_root~"/Models/Instruments/MFD/canvas/map/";
