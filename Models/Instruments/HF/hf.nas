...
var reset = "instrumentation/kfs-594/reset";
var prog = 0;
var t = 0;
...
var HF = {
  ...
  load_freq : func {
    ...
    foreach(var i;hf_mem) hfVec[i] = data.getValue(i);
    me.frq = hfVec[hf_mem[0]];
    me.display_freq(me.frq);
  },

  display_freq : func(freq) {
    for (var i=0;i<6;i+=1) {
      me.digit[me.text_dg[i]].setText(substr(freq,i,1));
