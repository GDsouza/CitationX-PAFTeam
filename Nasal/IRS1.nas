...
var cdu_init = props.globals.getNode("instrumentation/cdu[1]/pos-init",1);
var selected = props.globals.getNode("instrumentation/irs[1]/selected",1);
var posit = props.globals.initNode("instrumentation/irs[1]/positionned",0,"BOOL",1);
var align = props.globals.initNode("instrumentation/irs[1]/align",0,"BOOL",1);
var test = props.globals.initNode("instrumentation/irs[1]/test",0,"BOOL",1);
var f_align = 0; # flag
var f_fault = 0; # flag
...
var IRS1 = {
	new: func() {
		...
		m.irs1 = m.canvas.createGroup();
		canvas.parsesvg(m.irs1,"Aircraft/CitationX/Models/Instruments/IRS/IRS.svg");
		m.text = {};
		m.text_val = ["Align","Fault","NavRdy","NoAir","OnBatt","BattFail"];
		foreach(var i;m.text_val) {
			m.text[i] = m.irs1.getElementById(i);
		}
		m.text.Align.hide();
		m.text.Fault.hide();
		m.text.NavRdy.hide();
